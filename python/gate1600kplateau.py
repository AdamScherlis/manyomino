...
~1.73e7) before pooling by lineage.  Criteria: |z| < 3, pooled ESS >= 30
per lineage group, and both pooled means consistent with the nu-fit
expectation (within 3 pooled sigma of 1.73e7).
...
def main(burn):
    allcsv = glob.glob(os.path.join(ROOT, "n1600000_*.csv"))
